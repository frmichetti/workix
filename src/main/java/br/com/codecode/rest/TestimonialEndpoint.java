...
public class TestimonialEndpoint {
	...
	public Response findById(@PathParam("id") long id) {
		TypedQuery<Testimonial> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT t FROM Testimonial t WHERE t.id = :entityId ORDER BY t.id",
						Testimonial.class);
	...
	public List<Testimonial> listAll(
		...
		TypedQuery<Testimonial> findAllQuery = em.createQuery(
				"SELECT DISTINCT t FROM Testimonial t ORDER BY t.id",
				Testimonial.class);
