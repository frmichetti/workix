...
angular.module('workix',['ngRoute','ngResource'])
  .config(['$routeProvider', function($routeProvider) {
    $routeProvider
      ...
      .when('/Blogs',{templateUrl:'views/Blog/search.html',controller:'SearchBlogController'})
      .when('/Blogs/new',{templateUrl:'views/Blog/detail.html',controller:'NewBlogController'})
      .when('/Blogs/edit/:BlogId',{templateUrl:'views/Blog/detail.html',controller:'EditBlogController'})
